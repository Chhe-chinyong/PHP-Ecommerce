                                            ...
                                            <div class="col-lg-3">
                                                <ul>
                                                    <li class="mega-list-title">
                                                        ...
                                                        <a href="productItem.php">3D PRINTER & SUPPLIES</a></li>
                                                    <li>

                                                        <a href="productItem.php">3d Printer</a></li>
                                                    <li>

                                                        <a href="productItem.php">3d Printing Pen</a></li>
                                                    <li>

                                                        <a href="productItem.php">3d Printing Accessories</a></li>
                                                    <li>

                                                        <a href="productItem.php">3d Printer Module Board</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-3">
                                                <ul>
                ...
                <div class="ah-lg-mode">
                    ...
                    <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                        <li>
                            ...
                            <a href="index.php?page=productItem">NEW ARRIVALS</a></li>
                        <li class="has-dropdown">
                            ...
                            <ul style="width:170px">
                                <li class="has-dropdown has-dropdown--ul-left-100">
                                    ...
                                    <a href="index.php">Home<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>                          
                                ...
                                <li class="has-dropdown has-dropdown--ul-left-100">
                                    ...
                                    <a href="index.php?page=dashboard">Dashboard<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                ...
                                <li>
                                    ...
                                    <a href="index.php?page=cart">Cart</a></li>
                                ...
                                <li>
                                    ...
                                    <a href="index.php?page=404">404</a></li>
                            </ul>
                            <!--====== End - Dropdown ======-->
                        </li>
                        ...
                        <li>
                            ...
                            <a href="productItem.php">VALUE OF THE DAY</a></li>
                        <li>

                            <a href="productItem.php">GIFT CARDS</a></li>
                    </ul>
                    <!--====== End - List ======-->
                </div>
                <!--====== End - Menu ======-->
