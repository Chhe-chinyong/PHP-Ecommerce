...
<?php 
    ...
    if(isset($_GET['page']))
    {
        ...
        switch($page)
        {
            case "signup": $loadpage = "signup.php"; break;
            case "signin": $loadpage = "signin.php"; break;
            case "dashboard": $loadpage = "dashboard.php"; break;
            case "about": $loadpage = "about.php"; break;
            case "contact": $loadpage = "contact.php"; break;
            case "dashboard": $loadpage = "dashboard.php"; break;
            case "checkout": $loadpage ="checkout.php"; break;
            case "cart": $loadpage ="cart.php"; break;
            case "productItem": $loadpage ="productItem.php"; break;
            case "home": $loadpage = "home.php"; break;
            default: 
                $loadpage = "404.php";
        }
    }
